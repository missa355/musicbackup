...
var ReactJkMusicPlayer = /*#__PURE__*/function (_PureComponent) {
  ...
  function ReactJkMusicPlayer(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onControllerDragStop", function (e, _ref4) {
      var x = _ref4.x,
          y = _ref4.y;
    ...
    _defineProperty(_assertThisInitialized(_this), "loadAndPlayAudio", function () {
      ...
      var _this$state4 = _this.state,
          ...
          notAutoPlayUntilPlayClicked = _this$state4.notAutoPlayUntilPlayClicked;
  ...
  _createClass(ReactJkMusicPlayer, [{
    ...
    value: function render() {
      ...
      var _this$state11 = this.state,
          toggle = _this$state11.toggle,
          playing = _this$state11.playing,
          currentTime = _this$state11.currentTime,
          soundValue = _this$state11.soundValue,
          moveX = _this$state11.moveX,
          moveY = _this$state11.moveY,
          loading = _this$state11.loading,
          audioListsPanelVisible = _this$state11.audioListsPanelVisible,
          pause = _this$state11.pause,
          theme = _this$state11.theme,
          ...
          isMobile = _this$state11.isMobile,
          playMode = _this$state11.playMode,
          playModeTipVisible = _this$state11.playModeTipVisible,
          playModelNameVisible = _this$state11.playModelNameVisible,
          initAnimate = _this$state11.initAnimate,
          loadProgress = _this$state11.loadProgress,
          audioLists = _this$state11.audioLists,
          removeId = _this$state11.removeId,
          currentLyric = _this$state11.currentLyric,
          audioLyricVisible = _this$state11.audioLyricVisible;
